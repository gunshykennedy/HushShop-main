...
.enroll {
  @apply uppercase rounded-md px-4 py-2 text-white flex items-center ring-0 justify-center transform ease-in-out duration-200 hover:bg-indigo-400 focus:ring-offset-1 focus:ring-2;
}
.pricing {
